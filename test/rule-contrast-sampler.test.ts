...
test("text contrast uses sampled foreground color when text fill is missing", () => {
  const target: NormalizedTarget = {
    figmaUrl: "https://www.figma.com/file/demo?node-id=1-1",
    nodeId: "1:1",
    frameName: "Demo",
    ...
    nodes: [
      ...
      },
      {
        id: "1:2",
        parentId: "1:1",
        name: "Shift History Entry Header",
        type: "FRAME",
        bounds: { x: 0, y: 0, width: 200, height: 40 },
        fills: [],
        strokes: [],
      ...
      },
      {
        ...
        type: "TEXT",
        bounds: { x: 10, y: 10, width: 120, height: 18 },
        fills: [],
        strokes: [],
  ...
  const findings = textContrastRule.evaluate({
    ...
    reportStartIso: "2026-02-11T00:00:00.000Z",
    sampleBackgroundColor: () => ({ r: 248, g: 249, b: 250, a: 1 }),
    sampleForegroundColor: () => ({ r: 16, g: 43, b: 124, a: 1 }),
  });
...
test("text contrast prefers screenshot background over document fallback background", () => {
  const target: NormalizedTarget = {
    figmaUrl: "https://www.figma.com/file/demo?node-id=1-1",
    nodeId: "1:1",
    frameName: "Demo",
    warnings: [],
    contextSource: "metadata-fallback",
    fallbackBackgroundColor: { r: 69, g: 212, b: 42, a: 1 },
    nodes: [
      {
        id: "1:1",
        name: "Root",
      ...
      },
      {
        ...
        name: "Header",
        type: "TEXT",
        bounds: { x: 12, y: 12, width: 120, height: 18 },
        fills: [{ r: 16, g: 43, b: 124, a: 1 }],
        strokes: [],
        text: "Resource Page",
        isInteractive: false,
  ...
  const nodeFinding = findings.find((entry) => entry.targetRef.nodeId === "1:2");
  assert.equal(nodeFinding, undefined);
});
